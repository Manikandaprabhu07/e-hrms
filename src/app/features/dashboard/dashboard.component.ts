...
import { AuthService, DashboardService, FeedbackService, EmployeeService, TrainingService } from '../../core/services';
...
export class DashboardComponent {
  ...
  kpiStats = computed(() => {
    ...
    return [
      ...
      {
        title: 'Joining (This Quarter)',
        value: totals.employeesJoiningThisQuarter ?? 0,
        icon: 'JOIN',
        color: '#28a745'
      },
      {
        title: 'Relieving (This Quarter)',
        value: totals.employeesRelievingThisQuarter ?? 0,
        icon: 'REL',
        color: '#ffc107'
      }
    ];
